...
batman = movie.movie_info("Dark Knight", " Batman has been able to keep a tight lid on crime in Gotham City.",
                          "http://host.trivialbeing.org/up/tdk-jul1-dark-knight-poster-stupidbats.jpg",
                          "https://www.youtube.com/watch?v=_PZpmTj1Q8Q")
inception = movie.movie_info("Inception", "Inception is a 2010 science fiction film",
...
art = movie.movie_info("Diagonal Art", "Diagonal art program using python turtle", "art.PNG",
